...
export const B5819W_SL = (props: DiodeProps) => {
  ...
  "jlcpcb": [
    "C8598"
      ...
      footprint={<footprint>
        <smtpad portHints={["pin2"]} pcbX="1.700022mm" pcbY="0mm" width="1.1999976mm" height="0.9500108mm" shape="rect" />
<smtpad portHints={["pin1"]} pcbX="-1.700022mm" pcbY="0mm" width="1.1999976mm" height="0.9500108mm" shape="rect" />
